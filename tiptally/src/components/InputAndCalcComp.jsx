  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', width: '50%', marginRight: '1rem' }}>
      <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
        ...
        <input type="number" style={{fontFamily: 'Space Mono', backgroundColor: 'hsl(189, 41%, 97%)', border: '0', borderRadius: '.2rem', height: '1.7rem', width: '20rem', marginTop: '1rem', marginLeft: '1rem' , textAlign: 'right' }} />
      </div>
      ...
      <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', marginTop: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 30%)', gap: '1rem' }}>
          ...
          <input type="text" placeholder="Custom" style={{ fontFamily: 'Space Mono',  backgroundColor: 'hsl(189, 41%, 97%)', border: '0', borderRadius: '.4rem', height: '2.3rem', width: '5.7rem', marginTop: '1rem' , textAlign: 'right' , padding: '0 0.5rem'}} />
        </div>
      </div>
      ...
      <div style={{display: 'flex', flexDirection: 'column'}}>
          ...
          <input type="number" style={{fontFamily: 'Space Mono', backgroundColor: 'hsl(189, 41%, 97%)', border: '0', borderRadius: '.2rem', height: '1.7rem', width: '20rem', marginLeft: '1rem', textAlign: 'right' }} />
      </div>
